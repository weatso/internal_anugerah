...
export function CEOCommandCenter() {
  ...
  async function fetchAll() {
    ...
    // ΓöÇΓöÇ 1. Cash on Hand (Langsung dari Ledger Bank) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    const totalCash = (bankBalances || []).reduce((sum, b) => sum + Number(b.current_balance), 0)
    setCashOnHand(totalCash)

    // ΓöÇΓöÇ 2. P&L & Chart Data Aggregation (Tanpa Looping Ribuan Jurnal) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  return (
    ...
    >
      ...
      {/* ΓöÇΓöÇ KPI Bento Grid ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <motion.div variants={FADE_UP} className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        ...
        <BentoKPI
          ...
          sub={pendingInvoices > 0 ? 'Butuh persetujuan' : 'Semua bersih Γ£ô'}
        ...
        <BentoKPI
          ...
          sub={unreadLogs > 0 ? 'Dari divisi' : 'Semua telah direview Γ£ô'}
      ...
      {/* ΓöÇΓöÇ Revenue vs Expense Chart ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {chartData.length > 0 && (
      ...
      {/* ΓöÇΓöÇ Division Command Cards (Impersonation Panel) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
...
// ΓöÇΓöÇΓöÇ Bento KPI Card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
